// // @react-hooks/client-import-marking
...
<>
<div className="" style={{ 
  backgroundImage: "url('https://images.pexels.com/photos/7446416/pexels-photo-7446416.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')",
                ...
                <div className="grid md:grid-cols-2 items-center gap-16 sm:p-10 p-4 font-[sans-serif]">
                    <div>
                        ...
                        <ul className="flex mt-12 space-x-4">
                            <li className="bg-cyan-600 hover:bg-[#9fdfdfe2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                <a href="#">
                    ...
                    <div className=" p-6 rounded-lg">
                         <form className="mt-8 space-y-4">
                            <input type='text' placeholder='Name'
                                className="w-full rounded-md py-3 px-4 text-sm outline-[#4ca7a7]" />
                            <input type='email' placeholder='Email'
                                className="w-full rounded-md py-3 px-4 text-sm outline-[#a91079]" />
                            <input type='text' placeholder='Subject'
                                className="w-full  rounded-md py-3 px-4 text-sm outline-[#bfdee2]" />
                      <textarea placeholder='Message' rows={6} className="w-full rounded-md px-4 text-sm pt-3 outline-[#c4e2db]"></textarea>

                            <button type='button'
                                className="text-white bg-[#9beaec] hover:bg-[#69dbc8e2] font-semibold rounded-md text-sm px-4 py-3 flex items-center justify-center w-full">
